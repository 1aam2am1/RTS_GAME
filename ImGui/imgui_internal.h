...
IMGUI_API ImVec2
ImBezierClosestPoint(const ImVec2 &p1, const ImVec2 &p2, const ImVec2 &p3, const ImVec2 &p4, const ImVec2 &p,
...
struct IMGUI_API ImDrawListSharedData {
    ...
    ImVec2 ArcFastVtx[
            12 * IM_DRAWLIST_ARCFAST_TESSELLATION_MULTIPLIER];  // FIXME: Bake rounded corners fill/borders in atlas
...
enum ImGuiDockNodeFlagsPrivate_ {
    ...
    1 << 20,  // [EXPERIMENTAL] Prevent this node to be docked over another window/node.
...
namespace ImGui {
    ...
    IMGUI_API bool
    DockContextCalcDropPosForDocking(ImGuiWindow *target, ImGuiDockNode *target_node, ImGuiWindow *payload,
...
IMGUI_API void
ImFontAtlasBuildRender1bppRectFromString(ImFontAtlas *atlas, int atlas_x, int atlas_y, int w, int h, const char *in_str,
