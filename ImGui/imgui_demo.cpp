...
static void ShowDemoWindowTables() {
    ...
    if (ImGui::TreeNode("Resizable, stretch")) {
        ...
        static ImGuiTableFlags flags =
                ImGuiTableFlags_Resizable | ImGuiTableFlags_BordersOuter | ImGuiTableFlags_BordersV |
    ...
    if (ImGui::TreeNode("Resizable, fixed")) {
        ...
        static ImGuiTableFlags flags =
                ImGuiTableFlags_Resizable | ImGuiTableFlags_ColumnsWidthFixed | ImGuiTableFlags_BordersOuter |
    ...
    if (ImGui::TreeNode("Resizable, mixed")) {
        ...
        static ImGuiTableFlags flags =
                ImGuiTableFlags_ColumnsWidthFixed | ImGuiTableFlags_RowBg | ImGuiTableFlags_Borders |
    ...
    if (ImGui::TreeNode("Recursive")) {
        ...
        if (ImGui::BeginTable("recurse1", 2,
            ...
            ImGui::Text("A0 Cell 0");
            {
                ...
                if (ImGui::BeginTable("recurse2", 2, ImGuiTableFlags_Borders | ImGuiTableFlags_Resizable |
    ...
    if (ImGui::TreeNode("Sizing policies, cell contents")) {
        HelpMarker(
                "This section allows you to interact and see the effect of StretchX vs FixedX sizing policies depending on whether Scroll is enabled and the contents of your columns.");
        enum ContentsType {
            CT_ShortText, CT_LongText, CT_Button, CT_FillButton, CT_InputText
        };
        ...
        ImGui::SameLine();
        HelpMarker("Default if _ScrollX if disabled. Makes columns use _WidthStretch policy by default.");
        ...
        ImGui::SameLine();
        HelpMarker(
                "Default if _ScrollX if enabled. Makes columns use _WidthFixed by default, or _WidthFixedResize if _Resizable is not set.");
        ...
        static ImGuiTableFlags flags3 =
                ImGuiTableFlags_ColumnsWidthStretch | ImGuiTableFlags_ScrollX | ImGuiTableFlags_ScrollY |
    ...
    if (ImGui::TreeNode("Context menus")) {
        ...
        PushStyleCompact();
        ImGui::CheckboxFlags("ImGuiTableFlags_ContextMenuInBody", (unsigned int *) &flags1,
                             ImGuiTableFlags_ContextMenuInBody);
        PopStyleCompact();
        ...
        ImGuiTableFlags flags2 =
                ImGuiTableFlags_Resizable | ImGuiTableFlags_ColumnsWidthFixed | ImGuiTableFlags_Reorderable |
    ...
    if (ImGui::TreeNode("Sorting")) {
        ...
        if (ImGui::BeginTable("##table", 4, flags, ImVec2(0, TEXT_BASE_HEIGHT * 15), 0.0f)) {
            ...
            ImGui::TableSetupColumn("ID", ImGuiTableColumnFlags_DefaultSort | ImGuiTableColumnFlags_WidthFixed, -1.0f,
                                    MyItemColumnID_ID);
            ImGui::TableSetupColumn("Name", ImGuiTableColumnFlags_WidthFixed, -1.0f, MyItemColumnID_Name);
            ImGui::TableSetupColumn("Action", ImGuiTableColumnFlags_NoSort | ImGuiTableColumnFlags_WidthFixed, -1.0f,
                                    MyItemColumnID_Action);
    ...
    if (ImGui::TreeNode("Advanced")) {
        ...
        if (ImGui::TreeNode("Options")) {
            ...
            if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen)) {
                ...
                ImGui::SameLine();
                HelpMarker(
                        "If scrolling is disabled (ScrollX and ScrollY not set), the table is output directly in the parent window. OuterSize.y then becomes the minimum size for the table, which will extend vertically if there are more rows (unless NoHostExtendV is set).");
                ...
                ImGui::Combo("contents_type (first column)", &contents_type, contents_type_names,
        ...
        if (ImGui::BeginTable("##table", 6, flags, outer_size_enabled ? outer_size_value : ImVec2(0, 0),
            ...
            ImGui::TableSetupColumn("ID", ImGuiTableColumnFlags_DefaultSort | ImGuiTableColumnFlags_WidthFixed |
                                          ImGuiTableColumnFlags_NoHide, -1.0f, MyItemColumnID_ID);
            ImGui::TableSetupColumn("Name", ImGuiTableColumnFlags_WidthFixed, -1.0f, MyItemColumnID_Name);
            ImGui::TableSetupColumn("Action", ImGuiTableColumnFlags_NoSort | ImGuiTableColumnFlags_WidthFixed, -1.0f,
                                    MyItemColumnID_Action);
            ImGui::TableSetupColumn("Quantity (Long Label)",
                                    ImGuiTableColumnFlags_PreferSortDescending | ImGuiTableColumnFlags_WidthStretch,
