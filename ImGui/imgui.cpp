...
void ImGui::ShowMetricsWindow(bool *p_open) {
    ...
    struct Funcs {
        ...
        static void
        NodeDrawCmdShowMeshAndBoundingBox(ImGuiWindow *window, const ImDrawList *draw_list, const ImDrawCmd *draw_cmd,
        ...
        static void NodeTabBar(ImGuiTabBar *tab_bar) {
            ...
            if (open) {
                for (int tab_n = 0; tab_n < tab_bar->Tabs.Size; tab_n++) {
                    ...
                    ImGui::PushID(tab);
                    if (ImGui::SmallButton("<")) { TabBarQueueReorder(tab_bar, tab, -1); }
                    ImGui::SameLine(0, 2);
                    if (ImGui::SmallButton(">")) { TabBarQueueReorder(tab_bar, tab, +1); }
                    ImGui::SameLine();
